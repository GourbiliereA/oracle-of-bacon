...
```BASH
bin/neo4j-import --into data/databases/graph.db --nodes:Actor ../imdb-data/actors.csv \
--nodes:Movie ../imdb-data/movies.csv --relationships ../imdb-data/roles.csv
```
